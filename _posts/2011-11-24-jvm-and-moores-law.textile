...
Ryan actually mentioned that on his "blog":http://tomayko.com/writings/unicorn-is-unix on an unrelated topic, Unicorn.

bq. We should be doing more of this. A lot more of this. I’m talking about fork(2), execve(2), pipe(2), socketpair(2), select(2), kill(2), sigaction(2), and so on and so forth. These are our friends. They want so badly just to help us.
